...
export const templatesList = [
  {
    ...
    html: `
<h2 style="text-align: center"><strong>📘 Course Overview</strong></h2>
<p>Welcome to <strong>[Course Title]</strong>! In this course, you will gain practical knowledge and hands-on experience in <strong>[Topic/Skill]</strong>. Our goal is to help you master the core fundamentals and apply them to real-world scenarios.</p>

<h3><strong>🎯 Learning Objectives</strong></h3>
<ul>
  <li>Understand key concepts of [Topic]</li>
  <li>Develop practical projects using [Technology/Tool]</li>
  <li>Enhance problem-solving and debugging skills</li>
  <li>Build a portfolio-ready project</li>
</ul>
...
<h3><strong>👨‍🏫 Instructor</strong></h3>
<p><strong>[Instructor Name]</strong> is a professional developer and educator with over [X] years of experience teaching <strong>[Topic]</strong>. Known for clear explanations and practical examples.</p>

<hr/>
<p><em>💡 Tip: Download the course materials from the “Resources” section to follow along.</em></p>
    `,
  },
  {
...
<p><em>💡 টিপস: “Resources” সেকশন থেকে কোর্স ফাইল ডাউনলোড করুন।</em></p>
  ...
  {
    name: "Lesson Content Template (EN)",
    html: `
<h2><strong>Lesson Title: [Topic Name]</strong></h2>
<p>This lesson will guide you through <strong>[key concept or technique]</strong>. By the end, you’ll be able to <strong>[expected skill]</strong>.</p>

<h3><strong>🧩 Key Concepts</strong></h3>
<ul>
  <li>Understanding [Concept]</li>
  <li>Applying [Tool or Technique]</li>
  <li>Analyzing [Real-world Example]</li>
</ul>

<h3><strong>📹 Watch & Practice</strong></h3>
<p>Watch the attached video and follow along with the example project. After that, try completing the “Exercise” section below.</p>

<h3><strong>📝 Exercise</strong></h3>
<p>Create a simple [mini-project/task] using what you’ve learned in this lesson. Submit it through the “Assignments” tab.</p>
    `,
  },
  {
    name: "Instructor Profile (EN)",
...
<h2 style="text-align:center"><strong>👩‍🏫 Instructor Profile</strong></h2>
<div style="display:flex; align-items:center; gap:20px;">
  <img src="https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg" alt="Instructor Photo" style="width:120px; height:120px; border-radius:50%;" />
  <div>
    <h3><strong>[Instructor Name]</strong></h3>
    <p><em>[Title / Role, e.g., Frontend Engineer at XYZ]</em></p>
  </div>
</div>
<p>[Instructor Name] has over [X] years of professional experience in [Domain]. They specialize in <strong>[Skills]</strong> and have taught over [Number] students worldwide.</p>
...
<ul>
  ...
  <li><strong>Language:</strong> [English / Bangla]</li>
  <li><strong>Certificate:</strong> Yes</li>
  <li><strong>Instructor:</strong> [Name]</li>
</ul>
<p>Start your journey in <strong>[Topic]</strong> and gain the confidence to build <strong>[Outcome]</strong>. Learn by doing through practical lessons and guided projects.</p>
    `,
  },
  ...templates,
];
